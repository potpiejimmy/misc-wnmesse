package com.wincor.bcon.sampleapp.server.db.entity;
...
/**
 * A sample database entity class.
 * 
...
@NamedQueries({
    ...
    @NamedQuery(name = "SampleEntity.findById", query = "SELECT e FROM SampleEntity e WHERE e.id = :id")})
